...
const ChatBottom = ({ selectedType, onSendMessage, onOpenSettings, onSaveChat, savedChatId, onFeedback, onDeleteChat, onStartRecording, onStopRecording, isRecording, isCallActive }) => {
