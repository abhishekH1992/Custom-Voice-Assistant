...
import { REGISTER_MUTATION } from "../../graphql/mutations/auth.mutation";
            ...
            try {
                ...
                if (parsedError.code === 'BAD_USER_INPUT') {
                    if(parsedError.errors.email) {
                        toast.error(parsedError.errors.email);
                    } else {
                ...
                <div className="w-full max-w-md">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <Input
                            ...
                            startContent={<User className="text-xl text-default-400 pointer-events-none flex-shrink-0" />}
                        />
                        <Input
                            name="lastName"
                            label="Last Name"
                    ...
                    <div className="mt-4 text-center">
                        <Link href="/login" className="text-sm text-white">Already have an account? Login here</Link>
                    </div>
                </div>
            </div>
        </div>
